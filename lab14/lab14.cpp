...
// This program will convert change into dollars and take a service charge
 ...
 {          
            ...
            cout << "You have entered " << quarters_out << " quarters, " << dimes_out;
            cout << " dimes " << nickles_out << " nickles, " << total_with_only_pennys << " pennies" << endl;
            
            total_payout = (change_input - (change_input * .109)) * .01 ;                                                         //Take your fee
             
            cout <<"The total is $" << change_input / 100.0 << " After the fee you get $" << total_payout << endl;                //Output the total
